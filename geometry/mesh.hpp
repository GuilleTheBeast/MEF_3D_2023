...
/*Enumeradores para almacenar parametros de conductividad térmica y fuente de calor, asi como
las cantidades de numero de nodos, elementos y nodos con condiciones de contorno*/
enum parameter
{
...
// Clase "Mesh" con sus variables y métodos
class Mesh
{
private:
...
public:
    ...
    // Se libera espacio de los siguientes puntero dobles
    ~Mesh()
    {
        free(nodes);
        free(elements);
    ...
    // Setters y getters de la clase "Mesh"
    ...
    // Se inicializan los arreglos para numero de nodos, elementos y nodos con condiciones de contorno
    void init_arrays()
    {
    ...
    // Se muestran los datos obtenidos en consola de forma ordenada
    void report()
    {
        cout << "Problem Data\n**********************\n";
